...
TEST(Fire, dmg) {
  ...
  auto obj3 = new GoioObj("", CmpType::ARMOR);
  obj3->set_fire(20);
  EXPECT_EQ(1070.976_hp, Fire::get_fire_dmg(obj3, 27.89_s));
  delete obj3;

  auto obj4 = new GoioObj("", CmpType::COMPONENTS);
